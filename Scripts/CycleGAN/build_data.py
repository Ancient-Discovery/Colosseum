...
tf.flags.DEFINE_string('X_input_dir', r'data\oracle2bronze\trainA',
                       'X input directory, default: data\oracle2bronze\trainA')
tf.flags.DEFINE_string('Y_input_dir', r'data\oracle2bronze\trainB',
                       'Y input directory, default: data\oracle2bronze\trainB')
tf.flags.DEFINE_string('X_output_file', r'data\tfrecords\oracle.tfrecords',
                       'X output tfrecords file, default: data\tfrecords\oracle.tfrecords')
tf.flags.DEFINE_string('Y_output_file', r'data\tfrecords\\bronze.tfrecords',
                       'Y output tfrecords file, default: data\tfrecords\bronze.tfrecords')
